    ...
    children=[
        ...
        html.Div([
            ...
            html.Div([
                ...
                }, children=[html.P("Hover over a chart to see Agent details", style={'color': '#888', 'fontStyle': 'italic'})]),
...
def update_agent_insight(bar_hover, heatmap_hover):
    ...
    if not agent_name:
        return html.P("Hover over a chart to see Agent details", style={'color': '#888', 'fontStyle': 'italic'})
